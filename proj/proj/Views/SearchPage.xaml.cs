...
namespace proj.Views
{
    ...
    public partial class SearchPage : ContentPage
    {
        ...
        ObservableCollection<Student> NowselectedListPresnet;
        ...
        public void chechbox_CheckChanged(object sender, EventArgs e)
        {
            ...
            NowselectedListPresnet = new ObservableCollection<Student>();
            ...
            for (int i = 0; i < students.Count; i++)
            {
                ...
                if (item.IsChecked)
                {
                    NowselectedListAbsence.Add(item);
                }
